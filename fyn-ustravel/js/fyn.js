...
apps.findYourNumber = function () {
	...
	Knoema.Helpers.clientId = 'fsSa7bQ=';
 	...
 	this.countryDim = 'Country'; 	
	this.indicatorDim = 'Series'; 
 	this.meta = null;
	...
	$.getJSON('js/meta.json?version=1.2', $.proxy(function(result){
		...
		if (this.meta.dataset)
			this.dataset = this.meta.dataset;
		
		if (this.meta.countryDim)
			this.countryDim = this.meta.countryDim;
			
		if (this.meta.indicatorDim)
			this.indicatorDim = this.meta.indicatorDim;	
...
apps.findYourNumber.prototype.getCountries = function () {
	...
	Knoema.Helpers.get('/api/1.0/meta/dataset/' + this.dataset + '/dimension/' + this.countryDim, $.proxy(function (result) {
...
apps.findYourNumber.prototype.getIndicators = function () {
	...
	Knoema.Helpers.get('/api/1.0/meta/dataset/' + this.dataset + '/dimension/' + this.indicatorDim, $.proxy(function (result) {		
